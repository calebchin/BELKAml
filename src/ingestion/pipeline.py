...
class MoleculeDataPipeline:
    ...
    def process_data(self, bucket_name: str, file_name: str) -> pd.DataFrame:
        ...
        if file_name.endswith(".csv"):
            ...
            raise ValueError(f"Unsupported file type for {file_name}. Must be .csv or .parquet.")
        ...
        experimental_batch_num = self.config['data_preprocessing']['experimental_batch_num']
        # tz info
